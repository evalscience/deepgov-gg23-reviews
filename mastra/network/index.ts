...
export const researchNetwork = new AgentNetwork({
  ...
  instructions: `
      ...
      4. Return to the Primary Research Agent to synthesize all findings into a comprehensive report. Make it as as detailed as possible, aim for 3 or more pages (max 10 pages), include ALL the learnings from research.
